...
Next main M2 focus: harden meter-context acquisition and freeze a new
score/system for independent
key-state plus review-triage validation. Do not use the meter-deficit signal to
delete notes; it is review prioritization only. Pipeline integration remains
gated on independent exact-event/rest evidence and La Chata-style
generalization. See `docs/VLM_MELODY_SPIKE.md`.
